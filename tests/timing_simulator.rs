...
fn create_test_pipeline_config(stages: usize, forwarding: bool, branch_prediction: bool) -> PipelineConfig {
...
fn create_test_cache_config(size_bytes: usize, associativity: usize, block_size: usize) -> CacheConfig {
...
fn test_basic_pipeline_execution() {
    ...
    assert_eq!(simulator.registers.read(3), 22, "Register 3 should contain 22");
    
    // Verify PC ended at the right place
    assert!(simulator.pc >= 12, "PC should have advanced beyond the program");
}
...
fn test_pipeline_with_forwarding() {
    ...
    println!("Final register values with forwarding: $2={}, $3={}", 
             simulator.registers.read(2), 
             simulator.registers.read(3));
    
    assert_eq!(simulator.registers.read(2), 15, "Register 2 should contain 15");
    assert_eq!(simulator.registers.read(3), 30, "Register 3 should contain 30");
}
...
fn test_memory_access_patterns() {
    ...
    for i in 0..8 {
        ...
        assert_eq!(simulator.registers.read(reg), expected_value, 
                  "Register ${} should contain {}", reg, expected_value);
    }
}
